...
contract RetaERC20MinterPauser is Context, AccessControlEnumerable, RetaERC20Burnable, RetaERC20Pausable {
    ...
    function pause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "RetaERC20MinterPauser: must have pauser role to pause");
        _pause();
    }
    ...
    function _beforeTokenTransfer(
        ...
        address to,
        uint256 amount
    ) internal virtual override(ERC20, RetaERC20Pausable) {
